...
> **Do not add rules or agent definitions directly to this file.**
> This is a platform-specific wrapper for GitHub Copilot. All rules live in `.agents/rules/` and all skills live in `.agents/skills/`. See `AGENTS.md` for the full AI system reference.

## Project

A Hapi.js server-rendered web application using Nunjucks templates and the GOV.UK Design System.
...
- Consolidate happy-path assertions into one test per flow
- Assert only on dynamic values, never on static content
