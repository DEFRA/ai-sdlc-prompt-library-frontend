...
> This is a platform-specific wrapper for Claude Code. All rules live in `.agents/rules/` and all skills live in `.agents/skills/`. See `AGENTS.md` for the full AI system reference.
